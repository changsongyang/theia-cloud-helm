...
| demoApplication.name | string | `"theiacloud/theia-cloud-demo:1.1.0"` | The name of docker image to be used |
...
| landingPage.image | string | `"theiacloud/theia-cloud-landing-page:1.1.0"` | the landing page image to use |
...
| operator.image | string | `"theiacloud/theia-cloud-operator:1.1.0"` | The operator image |
...
| operator.wondershaperImage | string | `"theiacloud/theia-cloud-wondershaper:1.1.0"` | If bandwidthLimiter is set to WONDERSHAPER or K8SANNOTATIONANDWONDERSHAPER this image will be used for the wondershaper init container |
...
| service.image | string | `"theiacloud/theia-cloud-service:1.1.0"` | The image to use |
